...
#define SERVOMIN 580 // this is the 'minimum' pulse length in ms
#define SERVOMAX 2380 // this is the 'maximum' pulse length in ms
#define SERVOMID 1480
